...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<script src="/private/app/inventory.js"></script>
<script src="/private/controller/inventoryController.js"></script>
<script src="/private/service/inventoryService.js"></script>
<style>
.spinner {
	position: relative;
	width: 50px;
...
<script src="/private/app/MyInventory.js"></script>
<script src="/private/controller/Inventory.js"></script>
<script src="/private/service/InventoryService.js"></script>
					...
					<form ng-submit="submit()">
						...
						<div class="modal-body">
								...
								<p><label>ชื่อ</label></p>
									...
									<p><input type="number" class="form-control" name="number"
										ng-model="product.price" required /></p>
		...
		<div class="col-md-8" ng-controller="StockDetail">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<%@include file="../Views/Inventory/InventoryItem.jsp"%>
				</div>
			</div>