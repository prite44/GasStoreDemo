...
<script src="/private/app/MyCustomer.js"></script>
<script src="/private/controller/Customer.js"></script>
<script src="/private/service/CustomerService.js"></script>
		...
		<div class="col-md-8" ng-controller="CustomerDetail">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<%@include file="../Views/Customer/customerdetail.jsp"%>
				</div>
			</div>